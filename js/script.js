...
todoForm.addEventListener('submit', (ev) =>{
    ev.preventDefault()
        ...
        plus.classList.add('fa-shake')

    setTimeout(function(){
        plus.classList.remove('fa-shake')
    },900)
...
doubleCheckBtn.addEventListener('mouseenter', (e) => {
    doubleCheck.classList.add('fa-beat')
    
})
doubleCheckBtn.addEventListener('mouseleave', (e) => {
    doubleCheck.classList.remove('fa-beat')
...
eraseBtn.addEventListener('mouseenter', (e) => {
    deleteLeft.classList.add('fa-fade')
    
})
eraseBtn.addEventListener('mouseleave', (e) => {
    deleteLeft.classList.remove('fa-fade')
